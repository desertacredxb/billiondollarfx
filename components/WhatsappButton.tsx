...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed z-[9999] bottom-20 right-6 md:bottom-25 md:right-6 flex items-center justify-center bg-white w-12 h-12 md:w-16 md:h-16 rounded-full shadow-[0_4px_14px_rgba(0,0,0,0.4)] transition-all duration-300 ease-[cubic-bezier(0.175,0.885,0.32,1.275)] hover:-translate-y-1 hover:scale-105 active:scale-95 motion-reduce:transition-none motion-reduce:hover:transform-none"
    >
